...
class HeroGUI(Characters.Hero):
    def __init__(self, *args, **kwargs):
        ...
        self.rect = self.char_right_img.get_rect()
...
class GuardianGUI(Characters.Guardian):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.image = pygame.image.load(c.MURDOC_IMG).convert_alpha()
